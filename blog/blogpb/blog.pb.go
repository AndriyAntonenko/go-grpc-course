...
type Blog struct {
	...
	AuthroId string `protobuf:"bytes,2,opt,name=authro_id,json=authroId,proto3" json:"authro_id,omitempty"`
...
func (x *Blog) GetAuthroId() string {
	if x != nil {
		return x.AuthroId
	}
	return ""
...
var file_blog_blogpb_blog_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x61, 0x75, 0x74, 0x68, 0x72, 0x6f,
	0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x61, 0x75, 0x74, 0x68, 0x72,
	0x6f, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x03, 0x20, 0x01,
